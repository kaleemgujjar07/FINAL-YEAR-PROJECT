                                                ...
                                                <Stack mt={2} flexDirection={'row'} rowGap={is768?'2rem':''} columnGap={4} flexWrap={is768?"wrap":"nowrap"}>
                                                    ...
                                                    <Stack>
                                                        <img 
                                                            ...
                                                            src={product.product.images[0]?.startsWith('http') ? product.product.images[0] : `${process.env.REACT_APP_BASE_URL}${product.product.images[0]}`} 
                                                            alt={`${product.product.title}`} 
                                                            onError={(e) => {
                                                                e.target.onerror = null; 
                                                                if (!product.product.images[0]?.startsWith('/assets/')) {
                                                                    e.target.src = `https://picsum.photos/seed/${product.product._id}/400`;
                                                                }
                                                            }}
                                                        />
                                                    </Stack>

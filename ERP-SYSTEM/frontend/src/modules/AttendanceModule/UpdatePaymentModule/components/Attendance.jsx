...
export default function Attendance({ config, currentItem }) {
      ...
      <Row gutter={[12, 12]}>
        ...
        >
          <PageHeader
            ...
            ghost={false}
            tags={<span>{currentErp.attendanceStatus}</span>}
      ...
      <Row gutter={[12, 12]}>
        ...
        >
          ...
          <Descriptions title={`${translate('Client')} : ${currentErp.client.name}`} column={1}>
            ...
            <Divider dashed />
            <Descriptions.Item label={translate('Attendance Status')}>
              <span>{currentErp.attendanceStatus}</span>
            </Descriptions.Item>
        ...
        >
          <UpdateAttendance config={config} currentInvoice={currentErp} />
        </Col>
      </Row>
    </>
  );
